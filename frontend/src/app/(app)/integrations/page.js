...
function normalizeFormForCompare(form) {
  ...
  return {
    ...
    integrationStatus: String(form?.integrationStatus || "not_configured").trim(),
...
function getWorkspaceCopy(user, selectedAdminClinic) {
  ...
  if (user?.role === "super_admin") {
    ...
    return {
      ...
      description: selectedAdminClinic?.name
        ...
        : "Review and manage integration settings for the currently selected clinic.",

      loadingDescription:

        "Checking super-admin clinic context and preparing clinic integration controls.",
  ...
  return {
    ...
    description:
      ...
      "Review the current clinic integration status. This page stays read-only for owners.",

    loadingDescription:

      "Checking your session and preparing clinic integration status.",
...
export default function IntegrationsPage() {
  ...
  const hasChanges = useMemo(() => {
    ...
    return (
      ...
      JSON.stringify(normalizeFormForCompare(buildFormFromIntegrations(integrations)))
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const response = await api.patch(`/clinic-integrations/${targetClinicId}`, payload);
  ...
  if (!canViewIntegrationsPage(user)) {
    ...
    return (
      ...
      <PagePlaceholder
        ...
        description="Integrations is available only to owners and super admin."

        points={[

          "Owners can review integration status here",

          "Super admin can edit integration settings here",
  ...
  if (isSuperAdmin && !targetClinicId) {
    ...
    return (
      ...
      <PagePlaceholder
        ...
        description="Select a clinic in the admin workspace before opening Integrations."

        points={[

          "Use the admin clinic context",

          "Select the clinic you want to manage",

          "Return here to review or edit integrations",
        ...
        <section className="page-card stack-sm">
          ...
          <div className="stack-sm">
            ...
            <p className="integrations-subtle">
              ...
              This page uses the selected clinic workspace. Owners still see this page as read-only,

              while super admin can edit the same integration record safely.
        ...
        <section className="page-card stack">
          ...
          <div className="stack-sm">
            ...
            <p className="integrations-subtle">
              ...
              This clinic does not have integration settings yet. Owners can review them here once

              they exist, and super admin can edit them here once configured.
            ...
            <form className="page-card stack" onSubmit={handleSubmit}>
              ...
              <div className="integrations-card-header">
                ...
                <div className="stack-sm">
                  ...
                  <h3 className="integrations-card-title">Update clinic integrations</h3>

                </div>



                <span className={`status-pill ${getStatusTone(form.integrationStatus)}`}>
              ...
              <div className="integrations-details-grid">
                ...
                <label className="integrations-field">
                  ...
                  <input
                    ...
                    onChange={(event) => updateForm("googleCalendarId", event.target.value)}
                ...
                <label className="integrations-field">
                  ...
                  <input
                    ...
                    onChange={(event) => updateForm("makeWebhookUrl", event.target.value)}
                ...
                <label className="integrations-field">
                  ...
                  <input
                    ...
                    onChange={(event) => updateForm("ownerReportEmail", event.target.value)}
                ...
                <label className="integrations-field">
                  ...
                  <select
                    ...
                    onChange={(event) => updateForm("integrationStatus", event.target.value)}
                ...
                <label className="integrations-toggle-row">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      ...
                      updateForm("dailyOwnerReportEnabled", event.target.checked)
              ...
              <label className="integrations-field">
                ...
                <textarea
                  ...
                  onChange={(event) => updateForm("lastErrorMessage", event.target.value)}
            ...
            <article className="page-card stack integrations-full-width">
              ...
              <div className="integrations-readonly-note">
                ...
                {canEdit
                  ...
                  ? "This clinic is loaded in super-admin mode, so you can review and update the same integration record here."

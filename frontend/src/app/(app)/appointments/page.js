...
function createEditForm(appointment) {
  ...
  const end = splitLocalDateTimeValue(

    formatDateTimeInputValue(appointment.endTime)
...
export default function AppointmentsPage() {
  ...
  const [filterForm, setFilterForm] = useState(createInitialFilters());
  ...
  return (
    ...
    <div className="stack">
      ...
      <div className="page-header">
        ...
        <p className="muted">Create, review, and update appointments here.</p>
      ...
      <section className="page-card">
        ...
        <div className="section-heading">
          ...
          <div className="record-actions appointment-toolbar-actions">

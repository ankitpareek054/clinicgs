...
function getWorkspaceCopy(user, selectedAdminClinic) {
  if (user?.role === "super_admin") {
    return {
      ...
      description: selectedAdminClinic?.name
        ? `Manage services for ${selectedAdminClinic.name} from the clinic management flow.`
        : "Manage services for the selected clinic.",
      loadingDescription:
        "Checking selected clinic access and preparing clinic services.",
    };
  }
  ...
  return {
    ...
    loadingDescription: "Checking your session and preparing clinic services.",
  };
}
...
export default function ServicesPage() {
  ...
  async function handleEditSubmit(event) {
    ...
    try {
      ...
      await api.patch(
        `/clinic-services/${targetClinicId}/${editingServiceId}`,
        {
          serviceName: nextName,
  ...
  async function handleArchive(service) {
    const confirmed = window.confirm(
      `Archive ${service.serviceName || "this service"}?`,
    );
  ...
  if (isSuperAdmin && !targetClinicId) {
    return (
      <PagePlaceholder
        ...
        description="Open Clinics, select the clinic you want to manage, and then open Services from there."
        points={[
          "Go to Clinics from the sidebar",
          "Choose the clinic you want to manage",
          "Open Services from the clinic action panel",
        ]}
      />
    );
  }
    ...
    <div className="page stack">
        ...
        <section className="page-card stack-sm">
          <div className="stack-sm">
            ...
            <p className="services-subtle">
              Manage the service catalog for this clinic from here. Use the
              links below to move between clinic-specific pages.
            </p>
          </div>
      ...
      <section className="metrics-grid">
        ...
        <article className="metric-card">
          ...
          <p className="services-subtle">
            Services shown in the current section.
          </p>
        </article>
      </section>
        ...
        <form className="services-form" onSubmit={handleCreateSubmit}>
          <label className="services-field">
            ...
            <input
              ...
              onChange={(event) =>
                updateCreateForm("serviceName", event.target.value)
              }
      ...
      <section className="page-card stack-sm">
        <div className="stack-sm">
          ...
          <p className="services-subtle">
            Review all services already available for this clinic and update
            them if needed.
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <section className="page-card">
          <div className="empty-state">
            No services matched the current view.
          </div>
        </section>
      ) : (
                ...
                {!isEditing ? (
                    ...
                    <div className="services-card-header">
                      <div className="stack-sm">
                        <div className="services-card-topline">
                          ...
                          <span
                            className={`status-pill ${service.isActive ? "done" : "cancelled"}`}
                          >
                  ...
                  >
                    <div className="services-card-header">
                      ...
                      <span
                        className={`status-pill ${editForm.isActive ? "done" : "cancelled"}`}
                      >
                    ...
                    <label className="services-field">
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          updateEditForm("serviceName", event.target.value)
                        }
                        maxLength={200}
                        disabled={isBusy}
                        required

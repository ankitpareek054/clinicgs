...
function isRemovalRequest(requestType) {
  return (
    requestType === "remove_owner" || requestType === "remove_receptionist"
  );
}
...
export default function StaffRequestsPage() {
  ...
  function getClinicSelectionFromRequest(request) {
    ...
    return {
      ...
      status:
        ...
        "",
      city:
        request.clinicCity || request.clinic_city || clinicFromMap?.city || "",
    };
  }
  ...
  const loadStaffOptions = useCallback(async () => {
    ...
    try {
      ...
      setReceptionists(
        Array.isArray(receptionistsData) ? receptionistsData : [],
      );
    } catch (err) {
  ...
  const selectedRemovalUser = useMemo(() => {
    ...
    return (
      source.find(
        (item) => Number(item.id) === Number(createForm.targetUserId),
      ) || null
    );
  ...
  return (
    <div className="page stack">
        ...
        <div className="staff-requests-header-row">
          <div className="stack-sm">
            ...
            <p className="staff-requests-subtle">
              {isSuperAdmin
                ? "Review requests across clinics, filter them, and make final approval decisions from one queue."
      ...
      {(error || notice) && (
        <div
          className={error ? "error-banner" : "staff-requests-notice-banner"}
        >
          {error || notice}
        </div>
      )}
              ...
              <>
                ...
                {selectedRemovalUser ? (
                  <div className="staff-requests-inline-summary">
                    ...
                    <div>
                      {selectedRemovalUser.email || "No email available"}
                    </div>
      ...
      <section className="page-card stack-sm">
        <div className="stack-sm">
          ...
          <p className="staff-requests-subtle">
            Narrow the request list by clinic, status, request type, or
            pending-only view.
          </p>
        </div>
          ...
          <section className="page-card stack staff-requests-list-panel">
            ...
            <div className="staff-requests-list">
              {visibleRequests.map((request) => {
                const isActive =
                  Number(request.id) === Number(selectedRequestId);
                  ...
                  >
                    <div className="staff-requests-list-card-topline">
                      <div className="staff-request-topline">
                        ...
                        <span
                          className={`status-pill ${getStatusTone(request.status)}`}
                        >
                      ...
                      <span className="small-label">
                        {humanizeToken(
                          request.targetRole ||
                            getRequestTargetRole(request.requestType),
                        )}
                      </span>
                    </div>
              ...
              <>
                <section className="page-card stack">
                  ...
                  <div className="staff-request-details-grid">
                    <div className="staff-request-detail-card">
                      ...
                      <strong>
                        {selectedRequest.targetEmail || "Not provided"}
                      </strong>
                    </div>
                    ...
                    <div className="staff-request-detail-card">
                      ...
                      <strong>
                        {selectedRequest.targetPhone || "Not provided"}
                      </strong>
                    </div>
                    ...
                    <div className="staff-request-detail-card">
                      ...
                      <strong>
                        {getDecisionSummary(selectedRequest.status)}
                      </strong>
                    </div>
                  ...
                  <div className="staff-request-detail-actions">
                    ...
                    <button
                      ...
                      className="secondary-button compact-button"
                      onClick={() =>
                        activateClinicContext(selectedRequest, "/staff")
                      }
                    >
                      Open clinic staff
                    </button>
                ...
                {selectedRequest.requestNote ? (
                  <section className="page-card stack-sm">
                    ...
                    <p className="staff-request-copy">
                      {selectedRequest.requestNote}
                    </p>
                  </section>
                ) : null}
                ...
                {selectedRequest.status === "pending" ? (
                  <section className="page-card stack">
                    <div className="stack-sm">
                      ...
                      <p className="staff-requests-subtle">
                        Approve or reject this request and record the final
                        admin note.
                      </p>
                    </div>

                    <form
                      className="staff-requests-form"
                  ...
                  <section className="page-card stack-sm">
                    ...
                    <p className="staff-requests-subtle">
                      This request has already been decided and can no longer be
                      changed from this workflow.
                    </p>
                  </section>
                )}
                ...
                {decisionResultForSelected ? (
                  <section className="page-card stack">
                    <div className="stack-sm">
                      ...
                      <p className="staff-requests-subtle">
                        Shows the outcome returned by the backend after the most
                        recent decision on this request.
                      </p>
                    </div>
                    ...
                    <div className="staff-request-details-grid">
                      <div className="staff-request-detail-card">
                        ...
                        <strong>
                          {humanizeToken(
                            decisionResultForSelected.request?.status,
                            "Unknown",
                          )}
                        </strong>
                      </div>
                    ...
                    {decisionResultForSelected.createdUser ? (
                      <div className="staff-requests-inline-summary">
                        ...
                        <div>
                          {humanizeToken(
                            decisionResultForSelected.createdUser.role,
                          )}{" "}
                          /{" "}
                          {humanizeToken(
                            decisionResultForSelected.createdUser.status,
                          )}
                        </div>
                      </div>
                    ) : null}
